...
@ControllerAdvice
public class ResourceExcptionHandler extends RuntimeException {

    @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<StandardError> resourceExcptionHandler(ResourceNotFoundException e, HttpServletRequest request) {
